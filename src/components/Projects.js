      ...
      <div id="applications" style={{backgroundColor: "#F5F5F5"}}>
        <div>
          ...
          <Col style={{paddingLeft: "2.5em"}}  sm="6">
            <Card body style={{marginTop: "3em", backgroundColor: "#808080", textAlign: "center"}}>
              ...
              <a href="https://github.com/lucasromero18/q1-project-romero-fitness"><Button style={{color: "#add8e6"}}>Github</Button></a>
            </Card>
          </Col>
          <Col style={{paddingRight: "2.5em"}} sm="6">
            <Card body style={{marginTop: "3em", backgroundColor: "#808080", textAlign: "center"}}>
              ...
              <a href="https://github.com/lucasromero18/techConnect"><Button style={{color: "#add8e6"}}>Github</Button></a>
            </Card>
          </Col>
        </Row>
        <div>
        <Row>
          <Col style={{paddingLeft: "2.5em"}} sm="6">
            <Card body style={{marginTop: "2em", backgroundColor: "#808080", textAlign: "center"}}>
              ...
              <h1 style={{fontSize: ".9em", textAlign: "center", fontFamily: 'Montserrat, sans-serif', color: "#add8e6"}}>(4 day timeline)</h1>
              <a href="https://github.com/lucasromero18/q3project-frontend"><Button style={{color: "#add8e6"}}>Github</Button></a>
            </Card>
          </Col>
          <Col style={{paddingRight: "2.5em"}}  sm="6">
            <Card body style={{marginTop: "2em", backgroundColor: "#808080", textAlign: "center"}}>
              ...
              <h1 style={{fontSize: ".9em", textAlign: "center", fontFamily: 'Montserrat, sans-serif', color: "#add8e6"}}>(4 day timeline / Team Project)</h1>
              <a href="https://github.com/mpecicUSA/realGamingReviewsq4"><Button style={{color: "#add8e6"}}>Github</Button></a>
            </Card>
          </Col>
        </Row>
        <Row>
          <Col sm="6" className="offset-sm-3">
            <Card body style={{marginTop: "3em", marginBottom: "4em", backgroundColor: "#808080", textAlign: "center"}}>
              ...
              <a href="https://github.com/lucasromero18/yikers_frontend"><Button style={{color: "#add8e6"}}>GitHub</Button></a>
            </Card>
          </Col>
          </Row>
        </div>
