                ...
                <div style={{display: "inline-block"}}>
                  <h1 style={technical.styles}>Technical Skills</h1>
                    <div style={{marginTop: "2em", paddingBottom: "2em", marginLeft: "2.5em"}}>
                      <TroyBar percentageColor={'#add8e6'} skill={"HTML"} color={'#add8e6'} val={0.90} widthHeight={7.5} size={0.8}/>
                      <TroyBar percentageColor={'#add8e6'} skill={"CSS"} color={'#add8e6'} val={0.90} widthHeight={7.5} size={0.8}/>
                      <TroyBar percentageColor={'#add8e6'} skill={"javascript"} color={'#add8e6'} val={0.80} widthHeight={7.5} size={0.8}/>
                      <TroyBar percentageColor={'#add8e6'} skill={"React"} color={'#add8e6'} val={0.75} widthHeight={7.5} size={0.8}/>
                    </div>
                    <div style={{marginTop: "1em", paddingBottom: "1em", marginLeft: "2.5em"}}>
                      <TroyBar percentageColor={'#add8e6'} skill={"Vue"} color={'#add8e6'} val={0.65} widthHeight={7.5} size={0.8}/>
